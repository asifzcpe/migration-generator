...
use Asif\MigrationGenerator\Factories\MigrationGeneratorFactory;
...
class MigrationGeneratorCommand extends Command
{
    ...
    private $qualifiedNameSpace='\\Asif\\MigrationGenerator\\Factories\\Types\\';
    ...
    public function handle()
    {
       ...
       foreach($this->commandsArray as $c)
       {
            ...
            $this->commands.="\t".MigrationGeneratorFactory::generate(new $this->className(),$c['fieldName'],true,'new')."\n\t";
       }
	...
	{
		return file_get_contents(base_path('vendor/asif/migration-generator/src/stubs/'.$stubName.'.stub'));
    }
